...
import com.example.final_recipe_app.interfaces.GetDataService
import com.example.final_recipe_app.retrofitclient.RetrofitClientInstance
...
class DetailActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val imgToolbarBtnBack : ImageButton = findViewById(R.id.imgToolbarBtnBack)
    ...
    fun getSpecificItem(id:String) {
        ...
        call.enqueue(object : Callback<MealResponse> {
            ...
            override fun onResponse(
                ...
                val imgItem : RoundedImageView = findViewById(R.id.imgItem)
